...
<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/items/active/alta/tools/fertilize/ct_basic_fertilizer.png" alt="Soil Fertilizer icon" loading="lazy" width="auto" height="16px"/> **Soil Fertilizer** is a common food item.

The most basic ferilizer containing rich soils. Will likely poison you if consumed directly.
...
<details markdown="1"><summary>Can be used to craft: (Expand 29 items)</summary>
...
- ![ ](https://raw.githubusercontent.com/Ceterai/Enternia/main/objects/alta/crafting/dendrarium/icon.png) [Alta Dendrarium](https://ceterai.github.io/MyEnternia/Wiki/AltaDendrarium) (takes 0.1s, outputs <img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/items/active/alta/tools/fertilize/ct_basic_fertilizer.png" alt="Soil Fertilizer icon" loading="lazy" width="auto" height="16px"/> Soil Fertilizer x*1*):
  - <img src="https://starbounder.org/mediawiki/images/b/b6/Moonstone.png" alt="Moonstone icon" loading="lazy" width="10px" height="10px"/> [Moonstone](https://starbounder.org/Moonstone) x*2*
  - <img src="https://starbounder.org/mediawiki/images/f/fc/Moondust.png" alt="Moondust icon" loading="lazy" width="10px" height="10px"/> [Moondust](https://starbounder.org/Moondust) x*2*
...
- In-game ID: `ct_basic_fertilizer`
- Power: `1.0`
- Rarity: `Common`
...
- File: [`/items/active/alta/tools/fertilize/ct_basic_fertilizer.consumable`](https://github.com/Ceterai/Enternia/blob/main/items/active/alta/tools/fertilize/ct_basic_fertilizer.consumable)
