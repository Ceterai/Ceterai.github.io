...
The tag `crystalline` contains 21 total entries.

## Objects

<details markdown="1"><summary>Following objects have this colony tag: (Expand 15 items)</summary>
...
Following vanilla objects have this colony tag: [Starbounder: Tags: Crystalline](https://starbounder.org/Tag:Crystalline)
