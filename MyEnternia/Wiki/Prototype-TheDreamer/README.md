# Prototype: The Dreamer

<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/codex/alta/datamass/ionic.png" alt="Prototype: The Dreamer icon" loading="lazy" width="auto" height="16px"> **Prototype: The Dreamer** is a legendary codex entry.

A description of some advanced technology. Most of the data seems to be corrupted.  
Though the contents are unclear, an experienced alta will immediately know what it is about.

## Ingame

Species descriptions:

- Alta: This prototype seems to be related to the Dreamer project. I wonder what it could do?
...
- In-game ID: `ct_dreamer-codex`
- Level: `6`
- Power: `1.0`
- Rarity: `Legendary`
- Tags: [`data_source`](https://ceterai.github.io/MyEnternia/Wiki/Tags/DataSource), [`datamass`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Datamass), [`dreamer`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Dreamer), [`legendary`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Legendary)
- File: [`/codex/alta/ct_dreamer.codex`](https://github.com/Ceterai/Enternia/blob/main/codex/alta/ct_dreamer.codex)
