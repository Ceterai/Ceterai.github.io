...
- In-game ID: `ct_omniblue_umbrella`
- Level: `2`
- Power: `1.5`
- Rarity: `Common`
...
- File: [`/items/active/alta/tools/rain/blue_umbrella/parasol.activeitem`](https://github.com/Ceterai/Enternia/blob/main/items/active/alta/tools/rain/blue_umbrella/parasol.activeitem)
