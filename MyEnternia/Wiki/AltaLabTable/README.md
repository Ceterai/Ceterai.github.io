...
<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/objects/alta/lab/table/icon.png" alt="Alta Lab Table icon" loading="lazy" width="auto" height="16px"/> **Alta Lab Table** is an uncommon piece of furniture.

An easy-to-clean bion table with plenty of space both on and under it. Perfect for experiments!

## Ingame

<details markdown="1"><summary>Species descriptions: (Expand 8 items)</summary>

- Alta: A spacey bion table, can often be found in alta labs. It's pretty strong.
...
- In-game ID: `ct_alta_lab_table`
- Power: `2.5`
- Rarity: `Uncommon`
- Colony tags: [`alta`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Alta), [`alta_lab`](https://ceterai.github.io/MyEnternia/Wiki/Tags/AltaLab), [`commerce`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Commerce), [`uncommon`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Uncommon)
- File: [`/objects/alta/lab/table/ct_alta_lab_table.object`](https://github.com/Ceterai/Enternia/blob/main/objects/alta/lab/table/ct_alta_lab_table.object)
