...
<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/items/armors/alta/other/energy_mask/icon.png" alt="Energy Mask icon" loading="lazy" height=16px width="auto" /> **Energy Mask** is a legendary head item.
...
- Power: `1.0`
- Rarity: `Legendary`
- Tags: [`alta`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Alta), [`legendary`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Legendary), [`tier6clothing`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Tier6Clothing)
- File: [`/items/armors/alta/other/energy_mask/ct_alta_energy_mask.head`](https://github.com/Ceterai/Enternia/blob/main/items/armors/alta/other/energy_mask/ct_alta_energy_mask.head)
