...
The Alta Festive Station allows crafting of holiday-themed decorations, costumes, and special items for celebrating [Ceternity](https://ceterai.github.io/MyEnternia/Wiki/Ceternity), [Sona's Veil](https://ceterai.github.io/MyEnternia/Wiki/Sonaveil), [Ava Day](https://ceterai.github.io/MyEnternia/Wiki/Tags/AvaDay), and Alta National Day. Each holiday brings its own unique crafts and traditions, from spooky costumes to warm winter decorations to gift-giving items to patriotic displays.

## Ingame

<details markdown="1"><summary>Species descriptions: (Expand 8 items)</summary>

- Alta: The festival station! I love switching between holiday crafts throughout the year~ Each season brings new celebrations!
- Apex: Alta holiday crafting station. The organization by celebration type is efficient.
- Avian: A station for creating festival items! Altas seem to like celebrating, huh.
- Floran: Floran likesss bright colorss! Alta festivalss look fun!
- Glitch: Impressed. This station organizes crafts by cultural celebration with remarkable clarity.
- Human: Alta holiday station! Some of these celebrations seem familiar... Christmas-ish, Halloween-ish, Valentine's-ish.
- Hylotl: A beautiful approach to organizing seasonal celebrations through dedicated crafting. The respect for tradition is admirable.
- Novakid: Holiday craftin' station! Those altas sure know how to celebrate in style!
...
- In-game ID: `ct_alta_festive_station`
- Level: `6`
- Power: `1.0`
- Rarity: `Legendary`
- Colony tags: [`alta`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Alta), [`crafting`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Crafting), [`holiday`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Holiday), [`legendary`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Legendary)
- File: [`/objects/alta/crafting/festive_station/ct_alta_festive_station.object`](https://github.com/Ceterai/Enternia/blob/main/objects/alta/crafting/festive_station/ct_alta_festive_station.object)
