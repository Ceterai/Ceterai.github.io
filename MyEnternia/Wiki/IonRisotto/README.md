...
<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/items/generic/food/tier4/ct_ion_risotto.png" alt="Ion Risotto icon" loading="lazy" height="16px" width="auto" /> **Ion Risotto** is a legendary dish.

A great combination of the most popular ingridients from the nia cuisine.  
Though the preparation process might take some time, it is totally worth it in the end.

## Ingame

Species descriptions:

- Alta: A very decent, fulfilling risotto.
