...
<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/items/generic/food/tier1/ct_tsay_cooked.png" alt="Cooked Tsay icon" loading="lazy" width="auto" height="16px"> **Cooked Tsay** is a common dish.

Unlike its raw version, cooked tsay tastes mostly like meat. ...Unless you add some spices! Tasty!  
Adding spices and marinades to cooked tsays is a common practice among altas, who are not very fond of the taste of meat in general.

## Ingame

Species descriptions:

- Alta: Goes very well as a side-dish to something bitter or spicy, gives it a sort of balance in flavor.

## Parameters

Other variants:

- <img src="https://raw.githubusercontent.com/wiki/Ceterai/Enternia/images/icons/ct_tsay_cooked-perfect.png" alt="Perfectly Cooked Tsay icon" loading="lazy" width="auto" height="16px"> [Perfectly Cooked Tsay](https://ceterai.github.io/MyEnternia/Wiki/PerfectlyCookedTsay) ([perfect cooking](https://ceterai.github.io/MyEnternia/Wiki/PerfectCooking))
...
- In-game ID: `ct_tsay_cooked`
- Level: `2`
- Power: `1.0`
- Rarity: `Common`
- Tags: [`alta`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Alta), [`common`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Common), [`runeva_cuisine`](https://ceterai.github.io/MyEnternia/Wiki/Tags/RunevaCuisine), [`tsay`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Tsay)
