...
[Alta culture](https://ceterai.github.io/MyEnternia/Wiki/Alta#culture) revolves heavily around crystals and their utilization. This <img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/codex/alta/ebook/basic.png" alt="icon" loading="lazy" width="auto" height="16px"> [ebook](https://ceterai.github.io/MyEnternia/Wiki/Ebooks) describes different calin recipes and the culture around them.

## Ingame

Species descriptions:

- Alta: This book is a great way to learn about our crystal-based cuisine and its history.
...
- File: [`/codex/alta/ct_alta_food_calin.codex`](https://github.com/Ceterai/Enternia/blob/main/codex/alta/ct_alta_food_calin.codex)
