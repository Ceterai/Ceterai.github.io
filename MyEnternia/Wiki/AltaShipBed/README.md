...
<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/objects/alta/ship/bed/icon.png" alt="Alta Ship Bed icon" loading="lazy" width="auto" height="16px"> **Alta Ship Bed** is a rare piece of furniture.

These cosy beds can stack on top of each other.

## Ingame

<details markdown="1"><summary>Species descriptions: (Expand 8 items)</summary>

- Alta: I absolutely love these! You can build these with a window to see outside!
- Apex: A basic bunk bed.
- Avian: This bunk bed looks rather basic.
- Floran: Floran would like to sssleep in bunk bed.
- Glitch: Sentimental. A bunk bed, not dissimilar from those at the Protectorate academy.
- Human: A bunk bed. Not terribly spacious, but surprisingly comfortable.
- Hylotl: I have fond memories of sleeping in such a bed at the Protectorate academy.
- Novakid: A regular bunk bed.
...
- File: [`/objects/alta/ship/bed/ct_alta_ship_bed.object`](https://github.com/Ceterai/Enternia/blob/main/objects/alta/ship/bed/ct_alta_ship_bed.object)
