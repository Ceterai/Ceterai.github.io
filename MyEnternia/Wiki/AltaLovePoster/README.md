...
<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/objects/alta/special/events/ava_day/ct_alta_love_poster.png" alt="Alta Love Poster icon" loading="lazy" width="auto" height="16px"> **Alta Love Poster** is a common decorative object.

A cheerful poster celebrating [Ava Day](https://ceterai.github.io/MyEnternia/Wiki/Tags/AvaDay) - the alta friendship holiday where friends exchange gifts and appreciation!  
This poster features warm, friendly designs with hearts and stars, promoting the spirit of connection and appreciation. Alta Love is when altas celebrate all types of bonds - between friends, colleagues, caretakers, and loved ones. It's a day to show gratitude for the people who make life meaningful.

## Ingame

<details markdown="1"><summary>Species descriptions: (Expand 8 items)</summary>

- Alta: Happy Ava Day! Time to appreciate all my wonderful friends~
- Apex: A poster promoting an alta friendship celebration.
- Avian: Warm and inviting, celebrating bonds between people.
- Floran: Posster about friendsss! Floran likesss!
- Glitch: Pleased. A holiday dedicated to appreciation and connection.
- Human: Like Valentine's Day, but for all friendships! Sweet.
- Hylotl: A celebration of the bonds that unite us.
- Novakid: Friendship day poster! That's mighty wholesome.
...
- In-game ID: `ct_alta_love_poster`
- Level: `2`
- Power: `1.5`
- Rarity: `Common`
...
- Colony tags: [`alta`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Alta), [`common`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Common), [`valentines`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Valentines)
- File: [`/objects/alta/special/events/ava_day/ct_alta_love_poster.object`](https://github.com/Ceterai/Enternia/blob/main/objects/alta/special/events/ava_day/ct_alta_love_poster.object)
