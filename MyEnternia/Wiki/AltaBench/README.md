...
<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/objects/alta/city/bench/icon.png" alt="Alta Bench icon" loading="lazy" height="16px" width="auto" /> **Alta Bench** is a common piece of furniture.

A bench found in [alta](https://ceterai.github.io/MyEnternia/Wiki/Tags/Alta) cities, parks and labs.

## Ingame

<details markdown="1"><summary>Species descriptions: (Expand 8 items)</summary>

- Alta: I love these benches. They're always so clean and comfortable! And convenient, too.
- Apex: A nice, practical bench.
- Avian: It's a bench for sitting on. Unfortunately, I don't have time for that now.
- Floran: Bench looks comfortable to sssit on. If only Floran had time to do sso.
- Glitch: Observant. It's a bench made from metal.
- Human: It's a bench that fits several people. At least three!
- Hylotl: A wide bench.
- Novakid: If I had time to rest my legs, I would do it on this here bench. But I don't.
...
- In-game ID: `ct_alta_bench`
- Power: `1.5`
- Rarity: `Common`
- Colony tags: [`alta`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Alta), [`city`](https://ceterai.github.io/MyEnternia/Wiki/Tags/City), [`common`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Common), [`garden`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Garden)
- File: [`/objects/alta/city/bench/ct_alta_bench.object`](https://github.com/Ceterai/Enternia/blob/main/objects/alta/city/bench/ct_alta_bench.object)
