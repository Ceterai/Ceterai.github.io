...
<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/objects/alta/special/events/ava_day/ct_ava_day_giftbox1.png" alt="Ava Day Gift Box icon" loading="lazy" width="auto" height="16px"> **Ava Day Gift Box** is a common decorative object.

A beautifully wrapped gift box for [Ava Day](https://ceterai.github.io/MyEnternia/Wiki/Tags/AvaDay). The bow sparkles with crystalline threads!  
Gift boxes like this are exchanged during Ava Day celebrations. Traditionally, they contain small tokens of appreciation - chocolates, handmade items, datamasses with messages, or small crystals. The wrapping itself is considered part of the gift, with friends often competing to create the most beautiful presentations.

## Ingame

<details markdown="1"><summary>Species descriptions: (Expand 8 items)</summary>

- Alta: I love the way the ribbon catches the light~ I hope whoever receives this feels appreciated!
- Apex: A decorative gift container. Wrapped neatly.
- Avian: A lovely wrapped present with a shimmering bow.
- Floran: Pretty box! Floran wondersss what inssside!
- Glitch: Curious. A ceremonial gift container for friendship exchange.
- Human: A present! Wonder what's inside?
- Hylotl: Elegant packaging befitting a thoughtful gift.
- Novakid: That's a mighty pretty wrapped present!
...
- In-game ID: `ct_ava_day_giftbox1`
- Level: `2`
- Power: `1.5`
- Rarity: `Common`
...
- File: [`/objects/alta/special/events/ava_day/ct_ava_day_giftbox1.object`](https://github.com/Ceterai/Enternia/blob/main/objects/alta/special/events/ava_day/ct_ava_day_giftbox1.object)
