...
- In-game ID: `ct_alta_shark_tenant`
- NPC type: `ct_alta_shark_girl`
- Priority: `15`
- File: [`/tenants/alta/themed/cosplay/shark.tenant`](https://github.com/Ceterai/Enternia/blob/main/tenants/alta/themed/cosplay/shark.tenant)
