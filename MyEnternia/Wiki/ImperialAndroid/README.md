...
- In-game ID: `ct_alta_capital_android_tenant`
- NPC type: `ct_alta_capital_android`
- Priority: `15`
- File: [`/tenants/alta/androids/capital.tenant`](https://github.com/Ceterai/Enternia/blob/main/tenants/alta/androids/capital.tenant)
