...
<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/items/active/alta/glowsticks/omniblue.png" alt="Omniblue Glowstick icon" loading="lazy" width="auto" height="16px"/> **Omniblue Glowstick** is an uncommon throwable item.

Creates an omniblue bioluminescent glow when thrown. Is made from rare crystallic materials.  
Often used by [arknights](https://ceterai.github.io/MyEnternia/Wiki/Arknight) and other [eva](https://ceterai.github.io/MyEnternia/Wiki/Tags/Eva) altas for aircraft navigation. Different colors mean different responses, and same with movements.
...
- Tier 1 ![ ](https://raw.githubusercontent.com/Ceterai/Enternia/main/objects/alta/crafting/crafting_station/icon1.png) [Alta Crafting Station](https://ceterai.github.io/MyEnternia/Wiki/AltaCraftingStation) (takes 0.0s, outputs <img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/items/active/alta/glowsticks/omniblue.png" alt="Omniblue Glowstick icon" loading="lazy" width="auto" height="16px"/> Omniblue Glowstick x*2*):
  - <img src="https://starbounder.org/mediawiki/images/f/f8/Glow_Fibre.png" alt="Glow Fibre icon" loading="lazy" width="15px" height="14px"/> [Glow Fibre](https://starbounder.org/Glow_Fibre) x*3*
...
- File: [`/items/active/alta/glowsticks/omniblue.activeitem`](https://github.com/Ceterai/Enternia/blob/main/items/active/alta/glowsticks/omniblue.activeitem)
