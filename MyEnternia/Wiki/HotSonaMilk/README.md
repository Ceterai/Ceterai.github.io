...
<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/items/generic/food/events/sonaveil/ct_sona_milk_hot.png" alt="Hot Sona Milk icon" loading="lazy" width="auto" height="16px"/> **Hot Sona Milk** is an uncommon drink.

Served in a cup with a handle cause it's extra hot! The snow hill on top melts pretty quickly, cooling it down.  
A warm cup of sona milk, perfect for cold days. Sona milk is known for its rich, creamy texture and subtle sweetness, making it a comforting beverage to enjoy during the chilly Sonaveil season.

## Ingame

Species descriptions:

- Alta: A nice warm drink to help you stay cozy during Sonaveil~
...
- In-game ID: `ct_sona_milk_hot`
- Level: `4`
- Power: `1.0`
- Rarity: `Uncommon`
- Tags: [`alta`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Alta), [`alta_cuisine`](https://ceterai.github.io/MyEnternia/Wiki/Tags/AltaCuisine), [`holiday`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Holiday), [`sona`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Sona), [`sonaveil`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Sonaveil), [`uncommon`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Uncommon)
- File: [`/items/generic/food/events/sonaveil/ct_sona_milk_hot.consumable`](https://github.com/Ceterai/Enternia/blob/main/items/generic/food/events/sonaveil/ct_sona_milk_hot.consumable)
