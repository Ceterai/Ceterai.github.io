...
- for threat level **4+**:
- loot pool `ct_alta_pod_2` x*1* (always present):
  ...
  - <img src="https://raw.githubusercontent.com/wiki/Ceterai/Enternia/images/icons/ct_eds_shield-security.png" alt="Security Shield ★ icon" loading="lazy" width="auto" height="16px"> [Security Shield ★](https://ceterai.github.io/MyEnternia/Wiki/SecurityShield) x*1* (weight: 0.01)
