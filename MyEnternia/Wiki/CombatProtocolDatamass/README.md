# Combat Protocol Datamass

<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/codex/alta/datamass/combat.png" alt="Combat Protocol Datamass icon" loading="lazy" width="auto" height="16px"> **Combat Protocol Datamass** is a rare codex entry.

A list of short descriptions of some kind of regulations. Parts of data are corrupted. Code on the back reads 'CEN-411'.  
The regulations include regular alta combat protocols, special operations guidelines, and weaponized conflict strategies. The document is partially corrupted, with some entries missing or unreadable. The code on the back indicates that this is part of a larger set of documents related to combat protocols.

## Ingame

Species descriptions:

- Alta: I hope I never have to use this...
...
- In-game ID: `ct_combat-codex`
- Level: `5`
- Power: `1.0`
- Rarity: `Rare`
- Tags: [`combat`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Combat), [`data_source`](https://ceterai.github.io/MyEnternia/Wiki/Tags/DataSource), [`datamass`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Datamass), [`rare`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Rare)
- File: [`/codex/alta/ct_combat.codex`](https://github.com/Ceterai/Enternia/blob/main/codex/alta/ct_combat.codex)
