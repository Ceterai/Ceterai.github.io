...
<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/items/generic/produce/ct_tsay.png" alt="Tsay icon" loading="lazy" height=16px width="auto" /> **Tsay** is a common food item.
...
<details><summary>Can be harvested from: (Expand 10 items)</summary>
...
- Power: `1.0`
- Rarity: `Common`
- Tags: [`common`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Common), [`tsay`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Tsay)
- File: [`/items/generic/produce/ct_tsay.consumable`](https://github.com/Ceterai/Enternia/blob/main/items/generic/produce/ct_tsay.consumable)
