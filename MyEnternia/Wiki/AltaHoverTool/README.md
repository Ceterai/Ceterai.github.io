...
<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/items/active/alta/tools/rain/hover_tool/icon.png" alt="Alta Hover Tool icon" loading="lazy" width="auto" height="16px"> **Alta Hover Tool** is an uncommon tool.
...
- In-game ID: `ct_alta_hover_tool`
- Level: `4`
- Power: `2.5`
- Rarity: `Uncommon`
- Tags: [`alta`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Alta), [`hover_tool`](https://ceterai.github.io/MyEnternia/Wiki/Tags/HoverTool), [`uncommon`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Uncommon)
- File: [`/items/active/alta/tools/rain/hover_tool/parasol.activeitem`](https://github.com/Ceterai/Enternia/blob/main/items/active/alta/tools/rain/hover_tool/parasol.activeitem)
