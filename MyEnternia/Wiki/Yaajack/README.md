...
<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/objects/alta/special/events/ceternity/yaajack/icon.png" alt="Yaajack icon" loading="lazy" width="auto" height="16px"> **Yaajack** is an uncommon light source.
...
- Alta: A yaajack! Perfect for celebrating the spooky season~
- Apex: I'll give this one to altas - quite creative.
- Avian: Oh, how delightful! A melon lantern!
- Floran: Floran doesssn't understand. Where isss fire?
- Glitch: Interested. This 'jack o' lantern' doesn't have a candle.
- Human: I never thought melons could be so... festive.
- Hylotl: How innovative! It doesn't even need a candle.
- Novakid: Finally some decor that makes me feelin' home!
