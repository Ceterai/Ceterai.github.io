...
<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/objects/alta/lab/capsules/ct_capsule_icon.png" alt="Alta Lab Capsule icon" loading="lazy" width="auto" height="16px"/> **Alta Lab Capsule** is an uncommon breakable object.

A seemingly empty bionid capsule.

## Ingame

<details markdown="1"><summary>Species descriptions: (Expand 8 items)</summary>

- Alta: A lab storage capsule. There's always something useful inside.
- Apex: This object looks empty, but maybe it contains pixels.
- Avian: Doesn't glow, but might be full of other stuff!
- Floran: Floran wonderssss what's inssside.
- Glitch: Observant. It appears this object has something inside of it.
- Human: It's a chest! Or a capsule! Or a plane! Wait, no.
- Hylotl: Maybe there's something inside.
- Novakid: Let's open it up!
...
- In-game ID: `ct_capsule`
- Level: `4`
- Power: `2.5`
- Rarity: `Uncommon`
- Colony tags: [`alta`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Alta), [`alta_lab`](https://ceterai.github.io/MyEnternia/Wiki/Tags/AltaLab), [`misc`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Misc), [`uncommon`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Uncommon)
- File: [`/objects/alta/lab/capsules/ct_capsule.object`](https://github.com/Ceterai/Enternia/blob/main/objects/alta/lab/capsules/ct_capsule.object)
