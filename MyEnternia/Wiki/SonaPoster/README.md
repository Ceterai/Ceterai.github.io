...
<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/objects/alta/special/events/sonaveil/ct_sona_poster.png" alt="Sona Poster icon" loading="lazy" width="auto" height="16px"/> **Sona Poster** is a common decorative object.

A poster depicting a snowalta.  
This festive poster features a snowalta - an alta-shaped snowman figure that has become the beloved symbol of Sona's Veil celebrations. Snowaltas are built during the cold solstice season as a joyful winter activity, using snow, crystals, ayaka branches and fruit noses. They are often decorated with scarves, hats, and string lights to add warmth and cheer.

## Ingame

<details markdown="1"><summary>Species descriptions: (Expand 8 items)</summary>

- Alta: Cute snowalta poster! Building these is one of my favorite Sonaveil traditions~
- Apex: Alta snow sculpture poster. The anthropomorphic design is charming.
- Avian: An alta snowman!
- Floran: Snow robogirl... Sssnowgirl?..
- Glitch: Delighted. This snowalta is wearing a hat.
- Human: Alta snowman on a poster! They call them 'snowaltas' - I love it!
- Hylotl: A whimsical representation of finding joy in seasonal activities.
- Novakid: Snow critter poster! Looks mighty friendly and festive.
...
- Colony tags: [`alta`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Alta), [`common`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Common), [`sonaveil`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Sonaveil)
- File: [`/objects/alta/special/events/sonaveil/ct_sona_poster.object`](https://github.com/Ceterai/Enternia/blob/main/objects/alta/special/events/sonaveil/ct_sona_poster.object)
