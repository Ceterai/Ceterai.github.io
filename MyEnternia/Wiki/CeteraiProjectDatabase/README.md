# Ceterai Project Database

<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/codex/alta/datamass/plasma.png" alt="Ceterai Project Database icon" loading="lazy" width="auto" height="16px"> **Ceterai Project Database** is a legendary codex entry.

A list of unknown devices. It seems like it's missing some entries. Code on the back reads 'CEN-**0'.  
This is a datamass containing information about the Ceterai Project, a research and development initiative focused on advanced technology and energy systems. The entries are organized by their registration date and connections to other entries, with each entry assigned a unique identifier in the CTN format (thr. CEN-202).

## Ingame

Species descriptions:

- Alta: Oh no... I hope this isn't a bad sign.
...
- Tier 4 ![ ](https://raw.githubusercontent.com/Ceterai/Enternia/main/objects/alta/crafting/crafting_station/icon4.png) [Alta Crafting Station](https://ceterai.github.io/MyEnternia/Wiki/AltaCraftingStation), ![ ](https://raw.githubusercontent.com/Ceterai/Enternia/main/objects/alta/crafting/datacenter/icon.png) [Alta Datacenter](https://ceterai.github.io/MyEnternia/Wiki/AltaDatacenter) (takes 0.25s, outputs <img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/codex/alta/datamass/plasma.png" alt="Ceterai Project Database icon" loading="lazy" width="auto" height="16px"> Ceterai Project Database x*1*):
  ...
  - <img src="https://starbounder.org/mediawiki/images/8/82/Refined_Ferozium.png" alt="Refined Ferozium icon" loading="lazy" width="14px" height="14px"> [Refined Ferozium](https://starbounder.org/Refined_Ferozium) x*1*
...
- File: [`/codex/alta/ct_ceterai.codex`](https://github.com/Ceterai/Enternia/blob/main/codex/alta/ct_ceterai.codex)
