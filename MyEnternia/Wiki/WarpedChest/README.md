...
- for threat level **0+**:
  - loot pool `ct_warped_loot`:
    ...
    - <img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/items/armors/backitems/tigertail/tigertailicon.png" alt="Warped Glowtail icon" loading="lazy" width="auto" height="16px"> [Warped Glowtail](https://ceterai.github.io/MyEnternia/Wiki/WarpedGlowtail) x*1* (weight: 0.01)
