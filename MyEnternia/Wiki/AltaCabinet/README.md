...
<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/objects/alta/basic/cabinet/icon.png" alt="Alta Cabinet icon" loading="lazy" width="auto" height="16px"/> **Alta Cabinet** is a common storage unit.

A simple titanium locker. Has mechanical connectors to stack these on top of each other. **Is a platform. Can be placed on the ground, walls and ceiling.**  
...
- Alta: A regular cabinet, not much space inside. Doesn't mean there's nothing special in there.
...
- In-game ID: `ct_alta_cabinet`
- Level: `2`
- Power: `1.5`
- Rarity: `Common`
- Colony tags: [`alta`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Alta), [`common`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Common), [`storage`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Storage)
- File: [`/objects/alta/basic/cabinet/ct_alta_cabinet.object`](https://github.com/Ceterai/Enternia/blob/main/objects/alta/basic/cabinet/ct_alta_cabinet.object)
