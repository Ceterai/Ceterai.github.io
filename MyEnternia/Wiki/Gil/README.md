...
<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/items/generic/produce/ct_gil.png" alt="Gil icon" loading="lazy" height=16px width="auto" /> **Gil** is a common food item.
...
- Alta: Gils are pretty versatile, but <img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/items/generic/food/tier1/ct_gillikada.png" alt="Gillikada icon" loading="lazy" height=16px width="auto" /> [gillikadas](https://ceterai.github.io/MyEnternia/Wiki/Gillikada) are my favourite things to make out of them. Good thing some alta gardeners have their personal minigardens.
...
<details markdown="1"><summary>Can be harvested from: (Expand 17 items)</summary>
...
- Power: `1.0`
- Rarity: `Common`
- Tags: [`common`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Common), [`gil`](https://ceterai.github.io/MyEnternia/Wiki/Tags/Gil)
- File: [`/items/generic/produce/ct_gil.consumable`](https://github.com/Ceterai/Enternia/blob/main/items/generic/produce/ct_gil.consumable)
