...
<img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/objects/alta/lab/pod/icon.png" alt="Alta Lab Pod icon" loading="lazy" width="auto" height="16px"> **Alta Lab Pod** is a rare storage unit.
...
- for threat level **0+**:
  - loot pool `ct_alta_pod_3`:
    ...
    - <img src="https://raw.githubusercontent.com/Ceterai/Enternia/main/items/active/alta/spawners/androids/lab.png" alt="Alta Lab Android Nade icon" loading="lazy" width="auto" height="16px"> [Alta Lab Android Nade](https://ceterai.github.io/MyEnternia/Wiki/AltaLabAndroidNade) x*1* (weight: 0.004)
