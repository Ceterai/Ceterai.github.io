...
- Alta: The Empress's new year speech! Always makes me feel so hopeful and connected to all my sisters~
...
To all my beloved sisters across the stars,
...
As we step into this cycle together, I encourage you to do one of the following things:
...
We are connected by more than technology or biology. We are connected by choice, by purpose, by bonds we forge every day.

Here's to another year of discovery, growth, and sisterhood!
...
- File: [`/codex/alta/ct_alta_new_year.codex`](https://github.com/Ceterai/Enternia/blob/main/codex/alta/ct_alta_new_year.codex)
